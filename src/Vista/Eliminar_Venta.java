...
public class Eliminar_Venta extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btneliminar) {
            ...
            interfaz_Menu_Principal ventan = new interfaz_Menu_Principal();
            Controlador_Menu_Principal contventana = new Controlador_Menu_Principal(ventan);
    ...
    public void mensajeelimi() {
        ...
        if (codigo.length() == 0) {
            ...
            txtvent.requestFocus();
        } else {
            int opc = ctalla.getSelectedIndex();
            if(opc>0){
                lblresultado.setText("PAR ELIMINADO");
            } else  {
